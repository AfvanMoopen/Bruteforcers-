...
if bhydra == '01' or bhydra == '1':
 ...
 Brute Force")
  ...
  os.system("clear")
  os.system("router Speedy Brute Force")
  user = raw_input("[*] User : ")
  word = raw_input("[*] Wordlist : ")
  iphost = raw_input("[*] IP/Hostname : ")
 ...
 os.system("clear")
 os.system("facebookBrute Force")
 os.system("python2 facebook")

	
elif bhydra == '00' or bhydra == '0':
	os.system("python2 laser.py")
