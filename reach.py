...
def main():
	...
	print "   [08] Other\n"
	print "   [10] Exit the reach \n"
	reach  = raw_input("lzmx > ")
	
	if reach  == "1" or reach  == "01":
		print "\n    [01] Nmap"
		print "    [02] Red Hawk"
		print "    [03] D-Tect"
		print "    [04] sqlmap"
